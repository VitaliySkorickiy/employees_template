...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      data: [
        { name: 'John M.', salary: 2800, increase: false, rise: false, id: 1 },
        { name: 'Alex T.', salary: 1800, increase: true, rise: false, id: 2 },
        { name: 'Carl C.', salary: 1200, increase: false, rise: false, id: 3 }
      ],
      term: '',
      filter: 'all'
    }
